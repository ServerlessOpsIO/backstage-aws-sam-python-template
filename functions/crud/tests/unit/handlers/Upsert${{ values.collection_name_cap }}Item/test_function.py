'''Test Upsert${{ values.collection_name_cap }}Item'''
...
from src.handlers.Upsert${{ values.collection_name_cap }}Item.function import Output, ResponseBody

FN_NAME = 'Upsert${{ values.collection_name_cap }}Item'
DATA_DIR = './data'
...
def mock_fn(
    ...
    import src.handlers.Upsert${{ values.collection_name_cap }}Item.function as fn

    mocker.patch(
        'src.handlers.Upsert${{ values.collection_name_cap }}Item.function.DDB_TABLE',
...
def test_handler(
    ...
    mock_ddb_table_client.put_item(
        Item={
            'pk': mock_event.path_parameters.get('id'),
            'sk': mock_event.path_parameters.get('id')
        }
    )
