'''Test Delete${{ values.collection_name_cap }}Item'''
...
from src.handlers.Delete${{ values.collection_name_cap }}Item.types import Output, ResponseBody

FN_NAME = 'Delete${{ values.collection_name_cap }}Item'
DATA_DIR = './data'
...
def mock_fn(
    ...
    import src.handlers.Delete${{ values.collection_name_cap }}Item.function as fn

    mocker.patch(
        'src.handlers.Delete${{ values.collection_name_cap }}Item.function.DDB_TABLE',
