'''Test Get${{ values.collection_name_cap }}Item'''
...
from src.handlers.Get${{ values.collection_name_cap }}Item.types import Output, ResponseBody, ErrorResponseBody

FN_NAME = 'Get${{ values.collection_name_cap }}Item'
DATA_DIR = './data'
...
def mock_fn(
    ...
    import src.handlers.Get${{ values.collection_name_cap }}Item.function as fn

    mocker.patch(
        'src.handlers.Get${{ values.collection_name_cap }}Item.function.DDB_TABLE',
